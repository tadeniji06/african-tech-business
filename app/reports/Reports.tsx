	...
	return (
		<div className='relative min-h-screen p-6 bg-black text-white flex items-center justify-center overflow-hidden px-6'>
			...
			<div className='relative z-10 w-full max-w-6xl'>
				...
				{/* Main Content - Flex on Desktop */}
				<div className='flex flex-col md:flex-row items-center gap-8 md:gap-12 mb-12'>
					{/* Report Image - Smaller on Desktop */}
					...
					<div className='flex-1 text-center md:text-left space-y-6'>
						...
						<button
							...
							className='group relative bg-white text-black font-bold text-base px-8 py-4 rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center gap-3 mx-auto md:mx-0'
						>
							<Icon
								icon='mdi:download'
